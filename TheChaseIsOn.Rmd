...
ggplot(plot_data, aes(fill=OfferTaken, y=count, x=cuts)) + 
  ...
  scale_fill_manual(values=c("#207561", "#589167", "#a0cc78"  ))+
  scale_x_discrete(breaks=c("(0,1e+04]","(1e+04,2e+04]","(2e+04,3e+04]","(3e+04,4e+04]", "(4e+04,5e+04]",
                            "(5e+04,6e+04]", "(6e+04,7e+04]", "(7e+04,8e+04]", "(8e+04,9e+04]",
                            "(9e+04,1e+05]", "(1e+05,Inf]"),
                   labels=c("≤10k", "10-20k", "20-30k","30-40k","40-50k","50-60k","60-70k","70-80k",
                            "80-90k","90-100k",">100k"))+
